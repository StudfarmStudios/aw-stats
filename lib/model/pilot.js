...
Pilot.prototype.leave = function () {
...
Pilot.prototype.kill = function (victim) {
  ...
  stats.kill(this._id, victim ? victim._id : null, this.round.arena, this.round.id);
...
Pilot.prototype.death = function (killer) {
  ...
  stats.death(this._id, killer ? killer._id : null, this.round.arena, this.round.id);
  this.emit('died', killer);
};

Pilot.prototype.suicide = function () {
  ...
  stats.suicide(this._id, this.round.arena, this.round.id);
  this.emit('suicide');
  this.emit('died', this);
};

Pilot.prototype.spawn = function (details) {
...
Pilot.prototype.bonus = function (bonus) {
  console.log(this.username + " got a bonus " + bonus);
  stats.bonus(this._id, bonus, this.round.arena, this.round.id);
