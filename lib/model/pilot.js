...
Pilot.prototype.updateRating = function (rating) {
  ...
  this.client.send({token: this.token, rating: rating});
};
...
Pilot.prototype.kill = function (victim, pos) {
  ...
  //killer, victim, arena, roundId, pos, ship
  stats.kill(this._id, victim ? victim._id : null, this.round.arena.name, this.round.id, pos, this.currentShip);
...
Pilot.prototype.death = function (killer, pos) {
  ...
  //victim, killer, arena, pos, ship
  stats.death(this._id, killer ? killer._id : null, this.round.arena.name, this.round.id, pos, this.currentShip);
...
Pilot.prototype.suicide = function (pos) {
  ...
  stats.suicide(this._id, this.round.arena.name, this.round.id, pos, this.currentShip);
